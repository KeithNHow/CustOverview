/// <summary>
/// Report KNH Vendor Register (ID 50401).
/// </summary>
report 50401 "KNH Vendor Register"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Layouts/KNHVendorRegister.rdlc';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            column(PrintAmountsInLCY; gvPrintAmountsInLCY)
            {
            }
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                begin
                    ...
                    if gvPrintAmountsInLCY then begin
                        VendAmount := DtldVendLedgEntry."Amount (LCY)";
                        "Currency Code" := '';
                    end else
                        VendAmount := DtldVendLedgEntry.Amount;

                    VendAmountLCY := DtldVendLedgEntry."Amount (LCY)";
                    VendDebitAmountLCY := DtldVendLedgEntry."Debit Amount (LCY)";
                    VendCreditAmountLCY := DtldVendLedgEntry."Credit Amount (LCY)";
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(PrintAmountsInLCY; gvPrintAmountsInLCY)
                    {
                        ApplicationArea = Basic, Suite;
    ...
    begin
        gvPrintAmountsInLCY := NewPrintAmountsInLCY;
    end;
